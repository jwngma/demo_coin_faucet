...
class FreeCashPage extends StatefulWidget {
  static const String routeName = "/FreeCashPage";

  @override
  _FreeCashPageState createState() => _FreeCashPageState();
}
    ...
    firestoreServices
      ...
      showDialog(
          ...
          builder: (context) => CustomDialogWithOk(
                title: "Free Cash Bonus Added",
                description:
                    "You Have Claimed Your Free Cash Bonus Successfully",
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            !clicked
                                ? Container(
                                    ...
                                    child: clicked
                                        ...
                                        : TweenAnimationBuilder<Duration>(
                                            duration: Duration(
                                                seconds: userData.freeCashTimer - currentTimeInSeconds() <= 0
                                                    ? 1
                                                    : userData.freeCashTimer -
                            ...
                            userData.freeCashTimer - currentTimeInSeconds() <= 0
                                ? Container(
                                    width:
